            ...
            <section class="card m-2 cardlargura">
                <a href="https://olhardigital.com.br/2022/04/07/cinema-e-streaming/hq-da-marvel-sugere-que-jesus-poderia-ter-sido-um-mutante-dos-x-men/" class="limpar">
                    ...
                    <div class="card-body mt-2">
                        ...
                        <p>Jesus Cristo é um Mutante? É o que sugere um diálogo presente na HQ Immortal X-Men nº 1
                        </p>
                    </div>
                </a>
            ...
            <section class="card m-2 cardlargura">
                <a href="https://canaltech.com.br/quadrinhos/x-men-e-eternos-envolvem-os-vingadores-em-novas-saga-epica-da-marvel-213864/" class="limpar">
                    ...
                    <div class="card-body mt-2">
                        ...
                        <p>Os X-Men e os Eternos entrarão em conflito uns com os outros, em uma batalha para decidir quem são os verdadeiros deuses daquela realidade.
                        </p>
                    </div>
                </a>
            ...
            <section class="card m-2 cardlargura">
                <a href="https://www.omelete.com.br/marvel-cinema/x-men-97-mcu-roteirista-comenta" class="limpar">
                    ...
                    <div class="card-body mt-2">
                        ...
                        <p>X-Men 97 pode ter conexões com o MCU. Beau DeMayo, roteirista da série.
                        </p>
                    </div>
                </a>
            ...
            <section class="card m-2 cardlargura">
                <a href="https://olhardigital.com.br/2022/04/07/cinema-e-streaming/hq-da-marvel-sugere-que-jesus-poderia-ter-sido-um-mutante-dos-x-men/" class="limpar">
                    ...
                    <div class="card-body mt-2">
                        ...
                        <p>Oscar Isaac encontra-se atualmente ligado ao Universo da Marvel de diferentes formas e uma delas é através do filme X-Men: Apocalypse
                        </p>
                    </div>
                </a>
