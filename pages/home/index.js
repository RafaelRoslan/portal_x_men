            ...
            <section class="row justify-content-evenly">
                ...
                <div class="row justify-content-center align-items-center ">
                    <section class="card m-2 cardlargura">
                        <img src="imagens/imagem_meramente_ilustrativa" width="300" height="150" alt="">
                        <div class="card-body mt-2">
                            <h5>Notícia 1</h5>
                            <p>Voluptates, praesentium harum. Commodi eligendi saepe similique pariatur beatae quis iste magnam quidem praesentium tempora. Quam modi beatae pariatur accusantium, adipisci molestias nobis quod voluptas voluptatum dolor, consequuntur
                                sit animi?
                            </p>
                        </div>
                    </section>
