            ...
            <article class="col-12 col-sm-11 col-md-11 col-lg-11 col-xl-12 col-xxl-12  d-grid gap-4 text-justify">
              ...
              <section class="row d-flex justify-content-center">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 d-flex justify-content-center">
                  <img src="" alt="" class="img-fluid" width="250" height="400">
                </div>
              </section>
              <section class="row d-flex justify-content-center">
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 order-1">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 d-flex justify-content-center order-0">
                  <img src="" alt="" class="img-fluid" width="250" height="400">
                </div>
              </section>
              <section class="row d-flex justify-content-center">
